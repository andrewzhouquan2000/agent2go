    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="container py-16 sm:py-24">
          <div className="flex flex-col items-center text-center space-y-6 sm:space-y-8 px-4 sm:px-6">
        ...
        <section className="container py-12 sm:py-16">
          <div className="space-y-6 px-4 sm:px-0">
            <h2 className="text-2xl font-semibold text-center">同行都在用 Agent2Go</h2>
            <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 md:grid-cols-3">
              <Card className="overflow-hidden">
                <CardContent className="pt-6">
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-pink-100 to-pink-200 flex items-center justify-center text-2xl flex-shrink-0">🛍️</div>
                      <h3 className="font-semibold text-base">电商老板</h3>
                    </div>
              ...
              <Card className="overflow-hidden">
                <CardContent className="pt-6">
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-orange-100 to-orange-200 flex items-center justify-center text-2xl flex-shrink-0">🍽️</div>
                      <h3 className="font-semibold text-base">餐饮老板</h3>
                    </div>
                    <p className="text-sm text-muted-foreground leading-relaxed">
              ...
              <Card className="overflow-hidden">
                <CardContent className="pt-6">
                  <div className="space-y-4">
                    <div className="flex items-center gap-4">
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-100 to-blue-200 flex items-center justify-center text-2xl flex-shrink-0">📚</div>
                      <h3 className="font-semibold text-base">教培老板</h3>
                    </div>
                    <p className="text-sm text-muted-foreground leading-relaxed">
        ...
        {/* CTA Section */}
        <section className="container py-16 sm:py-20 bg-primary text-primary-foreground rounded-2xl mx-4 sm:mx-0">
