      ...
      <main className="flex-1">
        ...
        <section className="container py-12 bg-muted/50 rounded-lg">
          <div className="space-y-6">
            <h2 className="text-2xl font-bold text-center">同行都在用 Agent2Go</h2>
        ...
        <section className="container py-16 md:py-24">
          <div className="space-y-8">
            <div className="text-center space-y-2">
              <h2 className="text-3xl font-bold">为什么选择 Agent2Go？</h2>
              <p className="text-muted-foreground">专为小老板设计，简单易用，快速见效</p>
            </div>
            <div className="grid gap-6 md:grid-cols-3">
              <div className="rounded-lg border bg-card p-6 shadow-sm space-y-3">
                <div className="text-3xl">⚡</div>
                <h3 className="text-xl font-bold">10 分钟创建</h3>
                <p className="text-muted-foreground">
              ...
              <div className="rounded-lg border bg-card p-6 shadow-sm space-y-3">
                <div className="text-3xl">💰</div>
                <h3 className="text-xl font-bold">透明定价</h3>
                <p className="text-muted-foreground">
              ...
              <div className="rounded-lg border bg-card p-6 shadow-sm space-y-3">
                <div className="text-3xl">💬</div>
                <h3 className="text-xl font-bold">5 分钟客服响应</h3>
                <p className="text-muted-foreground">
        ...
        {/* CTA Section */}
        <section className="container py-16 bg-primary text-primary-foreground rounded-lg">
          <div className="flex flex-col items-center text-center space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button 
                size="lg" 
                variant="outline" 
                className="h-12 px-8 text-base bg-transparent border-primary-foreground/30 hover:bg-primary-foreground/10"
                asChild
              >
                <Link href="/pricing">
                  查看价格
